...
//actions		
	...
	public void Arifmetic() {
		...
		butt2.setText("+/-");
		butt3.setText("обн");
		butt4.setText("Проверка");
		buttZ.setText("Новые числа");
		jlbl3.setText("Числа от 0 до:");
		jlbl4.setText("На скорость:");
		...
		try {
			if (jlbl1.getText() == "+") {
				if ((Integer.parseInt(text1.getText())+Integer.parseInt(text2.getText())) == Integer.parseInt(text3.getText())) {
					...
					text4.append("Ответ правильный!\n");
				} else {
					text4.append(text1.getText() + " " + jlbl1.getText() + " " + text2.getText() + " " + jlbl2.getText() + " " + text3.getText() + "\n");
					text4.append("Ответ неправильный!\n");
				}
			} else {
				if ((Integer.parseInt(text1.getText())-Integer.parseInt(text2.getText())) == Integer.parseInt(text3.getText())) {
					text4.append(text1.getText() + " " + jlbl1.getText() + " " + text2.getText() + " " + jlbl2.getText() + " " + text3.getText() + "\n");
			...
			text4.append("Необходимо правильно заполнить все окна!\n");
		}
	}// Proverka
